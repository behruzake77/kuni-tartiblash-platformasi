 ...
 * Security headers apply to all routes; tighten CSP further when adding third-party scripts.
 */
...
const securityHeaders = [
      ...
      ]),
  {
    ...
    value: [
      "default-src 'self'",
      // next/font + inline styles for OG/runtime; tighten if you drop inline styles
